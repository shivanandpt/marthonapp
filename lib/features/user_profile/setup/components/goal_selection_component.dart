    ...
    return Column(
      ...
      children: [
        ...
        ...runningGoals.map((goal) {
          final isSelected = controller.selectedGoal == goal['value'];
          return Container(
            ...
            child: Card(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  controller.setGoal(goal['value']);
                  print(
                    'Controller goal after setting: ${controller.selectedGoal}',
                  );
                  print(
                    'Validation after goal selection: ${controller.validateCurrentStep()}',
                  );
                },
                borderRadius: BorderRadius.circular(12),
                child: Padding(
